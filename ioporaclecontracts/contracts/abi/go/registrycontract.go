...
//
// Solidity: function findOracleNodeByAddress(address _addr) view returns((address,string,bytes[],uint256,uint256,uint256))
...
//
// Solidity: function findOracleNodeByIndex(uint256 _index) view returns((address,string,bytes[],uint256,uint256,uint256))
...
//
// Solidity: function getNodePublicKeys(address addr) view returns(bytes[])
func (_RegistryContract *RegistryContractCaller) GetNodePublicKeys(opts *bind.CallOpts, addr common.Address) ([][]byte, error) {
	var out []interface{}
...
//
// Solidity: function getNodePublicKeys(address addr) view returns(bytes[])
func (_RegistryContract *RegistryContractSession) GetNodePublicKeys(addr common.Address) ([][]byte, error) {
...
//
// Solidity: function getNodePublicKeys(address addr) view returns(bytes[])
func (_RegistryContract *RegistryContractCallerSession) GetNodePublicKeys(addr common.Address) ([][]byte, error) {
	return _RegistryContract.Contract.GetNodePublicKeys(&_RegistryContract.CallOpts, addr)
}
...
// RegisterOracleNode is a paid mutator transaction binding the contract method 0x1ff741ca.
//
// Solidity: function registerOracleNode(string _ipAddr, bytes[] _pubKey, uint256 rank) payable returns()
func (_RegistryContract *RegistryContractTransactor) RegisterOracleNode(opts *bind.TransactOpts, _ipAddr string, _pubKey [][]byte, rank *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function registerOracleNode(string _ipAddr, bytes[] _pubKey, uint256 rank) payable returns()
func (_RegistryContract *RegistryContractSession) RegisterOracleNode(_ipAddr string, _pubKey [][]byte, rank *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function registerOracleNode(string _ipAddr, bytes[] _pubKey, uint256 rank) payable returns()
func (_RegistryContract *RegistryContractTransactorSession) RegisterOracleNode(_ipAddr string, _pubKey [][]byte, rank *big.Int) (*types.Transaction, error) {
	return _RegistryContract.Contract.RegisterOracleNode(&_RegistryContract.TransactOpts, _ipAddr, _pubKey, rank)
}
