...
// SubmitValidationResult is a paid mutator transaction binding the contract method 0x34b5a499.
//
// Solidity: function submitValidationResult(uint256 signature, uint256 rx, uint256 ry, uint256 _hash, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitValidationResult(opts *bind.TransactOpts, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitValidationResult", signature, rx, ry, _hash, validators)
}

// SubmitValidationResult is a paid mutator transaction binding the contract method 0x34b5a499.
//
// Solidity: function submitValidationResult(uint256 signature, uint256 rx, uint256 ry, uint256 _hash, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitValidationResult(signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitValidationResult(&_OracleContract.TransactOpts, signature, rx, ry, _hash, validators)
}

// SubmitValidationResult is a paid mutator transaction binding the contract method 0x34b5a499.
//
// Solidity: function submitValidationResult(uint256 signature, uint256 rx, uint256 ry, uint256 _hash, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitValidationResult(signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitValidationResult(&_OracleContract.TransactOpts, signature, rx, ry, _hash, validators)
}
