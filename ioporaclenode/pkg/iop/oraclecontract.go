...
// AllPubKeys is a free data retrieval call binding the contract method 0xd4cff25e.
//
// Solidity: function allPubKeys(uint256 , uint256 ) view returns(uint256)
func (_OracleContract *OracleContractCaller) AllPubKeys(opts *bind.CallOpts, arg0 *big.Int, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _OracleContract.contract.Call(opts, &out, "allPubKeys", arg0, arg1)
...
//
// Solidity: function allPubKeys(uint256 , uint256 ) view returns(uint256)
func (_OracleContract *OracleContractSession) AllPubKeys(arg0 *big.Int, arg1 *big.Int) (*big.Int, error) {
	return _OracleContract.Contract.AllPubKeys(&_OracleContract.CallOpts, arg0, arg1)
}

// AllPubKeys is a free data retrieval call binding the contract method 0xd4cff25e.
//
// Solidity: function allPubKeys(uint256 , uint256 ) view returns(uint256)
func (_OracleContract *OracleContractCallerSession) AllPubKeys(arg0 *big.Int, arg1 *big.Int) (*big.Int, error) {
	return _OracleContract.Contract.AllPubKeys(&_OracleContract.CallOpts, arg0, arg1)
}
...
//
// Solidity: function toBytes(uint256 x) pure returns(bytes b)
func (_OracleContract *OracleContractCaller) ToBytes(opts *bind.CallOpts, x *big.Int) ([]byte, error) {
	var out []interface{}
	err := _OracleContract.contract.Call(opts, &out, "toBytes", x)
...
//
// Solidity: function toBytes(uint256 x) pure returns(bytes b)
func (_OracleContract *OracleContractSession) ToBytes(x *big.Int) ([]byte, error) {
	return _OracleContract.Contract.ToBytes(&_OracleContract.CallOpts, x)
}

// ToBytes is a free data retrieval call binding the contract method 0x775a8f5e.
//
// Solidity: function toBytes(uint256 x) pure returns(bytes b)
func (_OracleContract *OracleContractCallerSession) ToBytes(x *big.Int) ([]byte, error) {
	return _OracleContract.Contract.ToBytes(&_OracleContract.CallOpts, x)
}
...
// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0xded00615.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitBlockValidationResult(opts *bind.TransactOpts, _result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitBlockValidationResult", _result, message, signature, rx, ry, _hash, keyX, keyBytes, _sha256, sha256Int, validators)
}

// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0xded00615.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitBlockValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitBlockValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, _sha256, sha256Int, validators)
}

// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0xded00615.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitBlockValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitBlockValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, _sha256, sha256Int, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0x9c4c3a4b.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitTransactionValidationResult(opts *bind.TransactOpts, _result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitTransactionValidationResult", _result, message, signature, rx, ry, _hash, keyX, keyBytes, _sha256, sha256Int, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0x9c4c3a4b.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitTransactionValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitTransactionValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, _sha256, sha256Int, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0x9c4c3a4b.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitTransactionValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitTransactionValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, _sha256, sha256Int, validators)
}
