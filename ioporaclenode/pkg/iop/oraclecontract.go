...
// SubmitValidationResult2 is a paid mutator transaction binding the contract method 0x38863024.
//
// Solidity: function submitValidationResult2(uint8 _typ, bool _result, bytes32 message, uint256 signature, uint256 pubKeyX, uint256 pubKeyY, uint256 rx, uint256 ry, uint256 _hash, address[] validators, uint256[2][] pubKeyArray) returns()
func (_OracleContract *OracleContractTransactor) SubmitValidationResult2(opts *bind.TransactOpts, _typ uint8, _result bool, message [32]byte, signature *big.Int, pubKeyX *big.Int, pubKeyY *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, validators []common.Address, pubKeyArray [][2]*big.Int) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitValidationResult2", _typ, _result, message, signature, pubKeyX, pubKeyY, rx, ry, _hash, validators, pubKeyArray)
}

// SubmitValidationResult2 is a paid mutator transaction binding the contract method 0x38863024.
//
// Solidity: function submitValidationResult2(uint8 _typ, bool _result, bytes32 message, uint256 signature, uint256 pubKeyX, uint256 pubKeyY, uint256 rx, uint256 ry, uint256 _hash, address[] validators, uint256[2][] pubKeyArray) returns()
func (_OracleContract *OracleContractSession) SubmitValidationResult2(_typ uint8, _result bool, message [32]byte, signature *big.Int, pubKeyX *big.Int, pubKeyY *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, validators []common.Address, pubKeyArray [][2]*big.Int) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitValidationResult2(&_OracleContract.TransactOpts, _typ, _result, message, signature, pubKeyX, pubKeyY, rx, ry, _hash, validators, pubKeyArray)
}

// SubmitValidationResult2 is a paid mutator transaction binding the contract method 0x38863024.
//
// Solidity: function submitValidationResult2(uint8 _typ, bool _result, bytes32 message, uint256 signature, uint256 pubKeyX, uint256 pubKeyY, uint256 rx, uint256 ry, uint256 _hash, address[] validators, uint256[2][] pubKeyArray) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitValidationResult2(_typ uint8, _result bool, message [32]byte, signature *big.Int, pubKeyX *big.Int, pubKeyY *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, validators []common.Address, pubKeyArray [][2]*big.Int) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitValidationResult2(&_OracleContract.TransactOpts, _typ, _result, message, signature, pubKeyX, pubKeyY, rx, ry, _hash, validators, pubKeyArray)
}
