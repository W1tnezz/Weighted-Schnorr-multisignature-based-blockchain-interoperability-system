...
// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0x07b63d6b.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitBlockValidationResult(opts *bind.TransactOpts, _result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitBlockValidationResult", _result, message, signature, rx, ry, _hash, keyBytes, _sha256, sha256Int, validators)
}

// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0x07b63d6b.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitBlockValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitBlockValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyBytes, _sha256, sha256Int, validators)
}

// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0x07b63d6b.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitBlockValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitBlockValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyBytes, _sha256, sha256Int, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0xbbd1bca4.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitTransactionValidationResult(opts *bind.TransactOpts, _result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitTransactionValidationResult", _result, message, signature, rx, ry, _hash, keyBytes, _sha256, sha256Int, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0xbbd1bca4.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitTransactionValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitTransactionValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyBytes, _sha256, sha256Int, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0xbbd1bca4.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, bytes keyBytes, bytes _sha256, uint256 sha256Int, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitTransactionValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyBytes []byte, _sha256 []byte, sha256Int *big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitTransactionValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyBytes, _sha256, sha256Int, validators)
}
