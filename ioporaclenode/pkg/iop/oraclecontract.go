...
// SubmitValidationResultBLS is a paid mutator transaction binding the contract method 0x759750e1.
//
// Solidity: function submitValidationResultBLS(uint8 _typ, bool _result, bytes32 message, uint256[2] _signature, uint256[2] _hash, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitValidationResultBLS(opts *bind.TransactOpts, _typ uint8, _result bool, message [32]byte, _signature [2]*big.Int, _hash [2]*big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitValidationResultBLS", _typ, _result, message, _signature, _hash, validators)
}

// SubmitValidationResultBLS is a paid mutator transaction binding the contract method 0x759750e1.
//
// Solidity: function submitValidationResultBLS(uint8 _typ, bool _result, bytes32 message, uint256[2] _signature, uint256[2] _hash, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitValidationResultBLS(_typ uint8, _result bool, message [32]byte, _signature [2]*big.Int, _hash [2]*big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitValidationResultBLS(&_OracleContract.TransactOpts, _typ, _result, message, _signature, _hash, validators)
}

// SubmitValidationResultBLS is a paid mutator transaction binding the contract method 0x759750e1.
//
// Solidity: function submitValidationResultBLS(uint8 _typ, bool _result, bytes32 message, uint256[2] _signature, uint256[2] _hash, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitValidationResultBLS(_typ uint8, _result bool, message [32]byte, _signature [2]*big.Int, _hash [2]*big.Int, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitValidationResultBLS(&_OracleContract.TransactOpts, _typ, _result, message, _signature, _hash, validators)
}
