...
//
// Solidity: function isOnCurve(uint256[4] point) pure returns()
func (_OracleContract *OracleContractCaller) IsOnCurve(opts *bind.CallOpts, point [4]*big.Int) error {
	var out []interface{}
...
//
// Solidity: function isOnCurve(uint256[4] point) pure returns()
func (_OracleContract *OracleContractSession) IsOnCurve(point [4]*big.Int) error {
...
//
// Solidity: function isOnCurve(uint256[4] point) pure returns()
func (_OracleContract *OracleContractCallerSession) IsOnCurve(point [4]*big.Int) error {
	return _OracleContract.Contract.IsOnCurve(&_OracleContract.CallOpts, point)
}
