...
// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0xa6a8abb7.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitBlockValidationResult(opts *bind.TransactOpts, _result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitBlockValidationResult", _result, message, signature, rx, ry, _hash, keyX, keyBytes, validators)
}

// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0xa6a8abb7.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitBlockValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitBlockValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, validators)
}

// SubmitBlockValidationResult is a paid mutator transaction binding the contract method 0xa6a8abb7.
//
// Solidity: function submitBlockValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitBlockValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitBlockValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0x0b8f7e1a.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, address[] validators) returns()
func (_OracleContract *OracleContractTransactor) SubmitTransactionValidationResult(opts *bind.TransactOpts, _result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitTransactionValidationResult", _result, message, signature, rx, ry, _hash, keyX, keyBytes, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0x0b8f7e1a.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, address[] validators) returns()
func (_OracleContract *OracleContractSession) SubmitTransactionValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitTransactionValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, validators)
}

// SubmitTransactionValidationResult is a paid mutator transaction binding the contract method 0x0b8f7e1a.
//
// Solidity: function submitTransactionValidationResult(bool _result, bytes32 message, uint256 signature, uint256 rx, uint256 ry, uint256 _hash, uint256 keyX, bytes keyBytes, address[] validators) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitTransactionValidationResult(_result bool, message [32]byte, signature *big.Int, rx *big.Int, ry *big.Int, _hash *big.Int, keyX *big.Int, keyBytes []byte, validators []common.Address) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitTransactionValidationResult(&_OracleContract.TransactOpts, _result, message, signature, rx, ry, _hash, keyX, keyBytes, validators)
}
