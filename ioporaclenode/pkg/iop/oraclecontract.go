...
// IsOnCurve is a free data retrieval call binding the contract method 0xb007edf6.
//
// Solidity: function isOnCurve(uint256[4] point) pure returns(bool)
func (_OracleContract *OracleContractCaller) IsOnCurve(opts *bind.CallOpts, point [4]*big.Int) (bool, error) {
	var out []interface{}
	err := _OracleContract.contract.Call(opts, &out, "isOnCurve", point)
...
//
// Solidity: function isOnCurve(uint256[4] point) pure returns(bool)
func (_OracleContract *OracleContractSession) IsOnCurve(point [4]*big.Int) (bool, error) {
	return _OracleContract.Contract.IsOnCurve(&_OracleContract.CallOpts, point)
}

// IsOnCurve is a free data retrieval call binding the contract method 0xb007edf6.
//
// Solidity: function isOnCurve(uint256[4] point) pure returns(bool)
func (_OracleContract *OracleContractCallerSession) IsOnCurve(point [4]*big.Int) (bool, error) {
	return _OracleContract.Contract.IsOnCurve(&_OracleContract.CallOpts, point)
}
